defmodule MatchingEngine do
  ...
  defp match_prices([], [], order_book) do
    order_book
  end

  defp match_prices([buy_head | _buy_tail], [sell_head | _sell_tail], order_book) do
  ...
  defp match_buy_sell_volume(buy_volume, sell_volume) do
  ...
  defp edit_volume(order_book, buy_price, buy_volume, sell_price, sell_volume) do
  ...
  defp edit_and_filter_out_zero_volume(list, order_price, order_volume) do
    list
    |> Enum.map(fn order ->
